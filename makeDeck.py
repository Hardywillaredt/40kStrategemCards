...
card_back_path = "C:/temp/TSonsStrategems/tauStrats/bg/cardback.png"
...
# === Save outputs ===
front_out_path = "C:/dev/40kStrategemCards/tauFront.png"
back_out_path = "C:/dev/40kStrategemCards/tauBack.png"
